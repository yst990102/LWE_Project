...
HD_PWD='E:/Github_repository/COMP3601/VHDL Work/Shi Tong Yuan/Shi Tong Yuan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_sum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matrix_sum.tcl -notrace
